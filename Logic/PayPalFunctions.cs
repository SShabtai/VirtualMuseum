...
public class NVPAPICaller
{
  ...
  public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
  {
    ...
    using (VirtualMuseum.Logic.ShoppingCartActions myCartOrders = new VirtualMuseum.Logic.ShoppingCartActions())
    {
      List<CartItem> myOrderList = myCartOrders.GetCartItems();

      for (int i = 0; i < myOrderList.Count; i++)
      {
        encoder["L_PAYMENTREQUEST_0_NAME" + i] = myOrderList[i].ArtItem.ItemID.ToString();
        encoder["L_PAYMENTREQUEST_0_AMT" + i] = myOrderList[i].ArtItem.UnitPrice.ToString();
  ...
  public string HttpCall(string NvpRequest)
  {
    ...
    {
            // Log the exception.
            VirtualMuseum.Logic.ExceptionUtility.LogException(e, "HttpCall in PayPalFunction.cs");
    }
